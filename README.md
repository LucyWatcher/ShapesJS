...
Of course, for now, you can run it by downloading `circlegrid.js` and `jscirclegrid.html` to a folder on your computer, and opening the HTML document. Eventually, this code will be hosted on the page of my portfolio website and you will be able to run it there.
